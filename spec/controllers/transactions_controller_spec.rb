...
describe TransactionsController do
  ...
  let(:valid_attributes) { { "payee" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved transaction as @transaction" do
        ...
        post :create, {:transaction => { "payee" => "invalid value" }}, valid_session
        expect(assigns(:transaction)).to be_a_new(Transaction)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested transaction" do
        ...
        expect_any_instance_of(Transaction).to receive(:update).with({ "payee" => "MyString" })
        put :update, {:id => transaction.to_param, :transaction => { "payee" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the transaction as @transaction" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Transaction.any_instance.stub(:save).and_return(false)
        put :update, {:id => transaction.to_param, :transaction => { "payee" => "invalid value" }}, valid_session
        expect(assigns(:transaction)).to eq(transaction)
      end
